...
export function SearchInput({ onSearch, placeholder = "Search logos..." }: SearchInputProps) {
    ...
    >
      <div className="relative group">
        ...
        <Input
          ...
          className="w-full h-14 pl-12 pr-4 text-lg bg-white dark:bg-neutral-900 rounded-2xl shadow-lg shadow-neutral-200/50 dark:shadow-black/30 hover:shadow-xl hover:shadow-neutral-300/50 dark:hover:shadow-black/40 border-0 ring-0 focus:ring-0 focus-visible:ring-0 focus:outline-none placeholder:text-neutral-400 dark:placeholder:text-neutral-500 text-neutral-900 dark:text-neutral-100 transition-all duration-300"
        />

        {/* Shortcut Hint */}
        {!value && (
          <div className="absolute right-4 top-1/2 -translate-y-1/2 hidden sm:flex items-center gap-1">
            <kbd className="px-2 py-1 text-xs font-medium text-neutral-400 bg-neutral-100 dark:bg-neutral-800 rounded shadow-sm">
              ⌘K
            </kbd>
          </div>
        )}
